...
CREATE TABLE public.tarife (
    ...
    idtarifegaraze integer NOT NULL,
    idvrijeme integer NOT NULL,
...
ALTER SEQUENCE public.tarife_idserial_seq OWNED BY public.tarife.idserial;
...
--
-- Name: tarife idserial; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tarife ALTER COLUMN idserial SET DEFAULT nextval('public.tarife_idserial_seq'::regclass);
...
COPY public.garaze (idgaraza, imegaraza, ulica, broj, kvart, brojmjesta, brojrazina, idtarife, tiplokacije, maksimalnavisina, dostupnostpovlastenekarte) FROM stdin;
1	Importanne Centar	Trg Ante Starčevića	7	Donji Grad	450	2	1	1	2.4	t
2	Importanne Galleria	Iblerov trg	10	Donji Grad	500	4	1	1	2.5	t
3	Langov trg - Langić	Trg Josipa Langa	13	Medvešćak	305	6	2	2	2.1	t
4	Cvjetni	Varšavska ulica	13	Centar	292	6	3	1	2.2	t
5	Petrinjska	Petrinjska ulica	59	Donji Grad	134	3	2	2	2.0	t
6	Kaptol Centar	Nova ves	17	Kaptol	461	2	1	1	2.1	t
7	Kvaternikov trg	Kvaternikov trg	6	Maksimir	354	3	4	2	2.1	t
8	KB Rebro	Kišpatićeva ulica	12	Maksimir	664	3	3	2	2.0	t
9	KB Sveti Duh	Sveti Duh	64	Črnomerec	477	4	5	3	2.0	t
10	Tuškanac	Tuškanac	1b	Tuškanac	465	4	2	2	2.3	t
11	Garage International	Miramarska	24	Trnje	447	9	7	1	2.2	t
\.
...
COPY public.tarife (idserial, idtarifegaraze, idvrijeme, cijena) FROM stdin;
1	1	1	2.00
2	2	2	1.60
3	2	3	0.80
4	3	1	2.60
...
ALTER TABLE ONLY public.tarife
    ADD CONSTRAINT tarife_pkey PRIMARY KEY (idserial);
